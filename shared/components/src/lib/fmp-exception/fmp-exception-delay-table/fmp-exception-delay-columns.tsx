import type { ExceptionDelay } from '@fes/shared-types';
...
export const fmpExceptionDelayColumns: FmpTableColumn<ExceptionDelay>[] = [
  {
    id: 'andonStatus',
  ...
  },
  {
    ...
    outerRender: ({ record, children }) => {
      return (
        <div className="fmp-exception-delay-table__cell-investigation">
          {record.doneBy && record.hardClosed ? (
            <div className="fmp-exception-delay-table__cell-investigation-byline">
